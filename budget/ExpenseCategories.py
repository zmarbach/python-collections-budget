...
def main():
    ...
    # zip creates a list of tuples, where element from each list are paired together
    # so a is item from for_loop and b is item from set_comp
...
expenses.read_expenses('data/spending_data.csv')
    ...
    print(f"Expenses divided by category --> {divided_expenses_sum}")

    # This will take the list of expenses and automatically calc the percentages
